<?php
    ...
    if(!empty($_POST['send'])){
        ...
        $query = mysqli_query($con,"SELECT email FROM client WHERE email='$email';");
        $data = mysqli_fetch_assoc($query); 

        if(!is_null($data["email"])){
            $error = "E-mail utilisé par un autre client !";
        
        } else {
            $query = mysqli_query($con,"INSERT INTO client (nom, prenom, email, password) 
                                        VALUES ('$nom', '$prenom', '$email', '$password') ");
                if($query){
                    $succes = "Compte crée !";
                } else {
                    $error = "Compte n'est pas crée !";
            }
        }    
    }
...
<body>
		...
		<span class="ti-align-justify"></span>
            ...
            <div class="collapse navbar-collapse" id="navbarsExample09">
                <ul class="navbar-nav ml-auto">
                    ...
                    ?> 
                </ul><div class="popup" onclick="myFunction()">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                while($liste = mysqli_fetch_array($query7)){
                                    ...
                                    <td>'.$price.'</td>                                
                                    <td>'.$quantity.'</td>
                                    <td><a href="inscription.php?del='.$idprod.'" class="del"><img src="images/trash.png" ></a></td>
                                    </tr>';
                                } }?>
    ...
    <section class="contact section">
        <div class="container">
            ...
            <div class="col-lg-12">
                    <div class="text-center">
                        <h1 class="text-capitalize mb-0 text-lg">Créer un Compte</h1>
                    </div>
                </div>
                <div class="col-lg-8">
                    <form id="contact-form" class="contact__form mt-5" method="POST" action="inscription.php">
                        ...
                        <div class="form-row">                            
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="col-lg-12">                              
                                    <div class="text-center">
                                        <input type="submit" name="send" class="btn btn-main" value="Valider">
                                    </div>
                                </div>
                            </div>
                        <?php
