...
<?php
    ...
    $req_wallpaper = mysqli_query($con,'SELECT wallpaper_type , nom_categorie, nom_type, id_t
                                FROM type 
                                    JOIN categorie ON (id_categorie = id_ct)
                                WHERE  id_categorie = id_ct 
                                ORDER BY RAND();');                

    $req_quotes = mysqli_query($con,'SELECT contenu
                                 FROM quotes');    
...
<body>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                while($liste = mysqli_fetch_array($query7)){
                                    ...
                                    <td>'.$price.'</td>                                
                                    <td>'.$quantity.'</td>
                                    <td><a href="index.php?del='.$idprod.'" class="del"><img src="images/trash.png" ></a></td>
                                    </tr>';
                                } }?>
            ...
            <div class="row">
                <div class="col-lg-10">
                    <h2 class="cd-headline clip is-full-width mb-4 ">
                        Hey, Bienvenue Chez Lina Belle<br>
                        <span class="cd-words-wrapper text-color">
                        <b class="is-visible">Que cherchez-vous ?</b>
                        <?php 
                             while($quote = mysqli_fetch_array($req_quotes)){
                                $quote['contenu'];
                            echo '<b>'.$quote['contenu'].'</b>';
                            }
                        ?>   
                        </span>
                    </h2>
    ...
    <section class=" portfolio ">
        <div class="container">
            ...
            <?php 
            while($row = mysqli_fetch_array($req_wallpaper)){         
             ?>
                <div class="col-lg-4 col-6 mb-4 shuffle-item"  data-groups="[&quot;'<?php echo $row['nom_categorie']; ?>'&quot;]">
                    <div class="position-relative inner-box">
                        <div class="image position-relative ">
                        <img src="data:image/jpeg;base64,<?php echo base64_encode($row['wallpaper_type']);?>" class="img-fluid w-100 d-block">
