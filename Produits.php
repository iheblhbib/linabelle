<?php
    ...
    $query2 = mysqli_query($con,'SELECT nom_categorie
                              FROM categorie  ');
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                while($liste = mysqli_fetch_array($query7)){
                                    ...
                                    <td>'.$price.'</td>                                
                                    <td>'.$quantity.'</td>
                                    <td><a href="produits.php?del='.$idprod.'" class="del"><img src="images/trash.png" ></a></td>
                                    </tr>';
                                } }?>
    ...
    <section class="page-title section pb-0">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                    <h2 class="display-3">Nous presentant tous <br> <span class="text-color">Lina Belle </span>produits.</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class=" portfolio ">
        <div class="container">
            ...
            while($row = mysqli_fetch_array($req_prods)){
             ?>
                <div class="col-lg-3 col-4 mb-4 shuffle-item"  data-groups="[&quot;<?php echo $row['nom_type']; ?>&quot;]">
