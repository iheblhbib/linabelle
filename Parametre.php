   ...
   <?php
    ...
    $query = mysqli_query($con,"SELECT nom, prenom, email, password
                                FROM client
                                WHERE email='$email_id'");
    $data = mysqli_fetch_array($query);
    $nom_bd = $data['nom'];
    $prenom_bd = $data['prenom'];
    ...
    if(!empty($_POST['send'])){
        ...
        $req = mysqli_query($con,"UPDATE `client` 
    ...
    if(!empty($_POST['send'])){
        ...
        if ($nom_bd == $nom && $prenom_bd == $prenom){
            if ( $password_bd == $password || empty($password)){ 
                $none = true ;
                $succes = false ;
                $error = false ;
            }
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <?php 
                     ...
                     ?>
                      ...
                      <?php  } else { ?>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $nom_id.' '.$prenom_id ;?></a>
                                <ul class="dropdown-menu" aria-labelledby="dropdown05">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <td><a href="parametre.php?del=<?php echo $liste['id_prod']; ?>" class="del"><img src="images/trash.png" ></a></td>
                                    </tr>';
                                <?php   } 
                                    }
                                ?>
    ...
    <section class="contact section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="text-center">
                        <h1 class="text-capitalize mb-0 text-lg">Votre Cordonnées</h1>
                    </div>
                </div>
                <div class="col-lg-8">
                    <form id="contact-form" class="contact__form mt-5" method="POST" action="Parametre.php">

                        <!-- form message no changes -->
                        <div class="row">
                            <div class="col-12">
                                <?php if($none){ ?> 
                                    <div class="alert alert-secondary contact__msg" role="alert">
                                        Aucune modification !
                                    </div>
                                <?php } ?>
                            </div>
                        ...
                        <div class="form-row" > 
                            <div class="input-group mb-3 col-lg-6">
                                ...
                                <input name="nom" type="text" class="form-control text-capitalize" value="<?php echo $data["nom"] ?>">
                            </div> 
                            ...
                            <div class="input-group mb-3 col-lg-6">
                                ...
                                <input name="prenom" type="text" class="form-control text-capitalize" value="<?php echo $data["prenom"]?>">
                            </div> 
                            ...
                            <div class="input-group mb-3 col-lg-12">
                                ...
                                <input name="email" type="email" class="form-control " value="<?php echo $data["email"]?>" readonly>
                            </div> 
                            ...
                            <div class="col-lg-6">                              
                                <div class="text-center">
                                    <input type="button" onclick="goBack()" class="btn btn-dark" value="Retour ?">      
                                </div>
                            </div>
                            <script>
                                function goBack() {
                            ...
                            <div class="col-lg-6">                              
                                <div class="text-center">
                                    <input type="submit" name="send" class="btn btn-main" value="Mise à jour">      
                                </div>
                            </div>                            
