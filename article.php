                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdown02">
                            ...
                            <li><a class="dropdown-item" href="Gel Douche.php">Gel Douche</a></li>
                            <li><a class="dropdown-item" href="Shampooing.php">Shompooing</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <h1 class="text-capitalize mb-0 text-lg">Blog Grid</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="post mb-5">
                        <a class="image-content" href="article.php">
                            <img src="images/blog/minimal-1.jpg" alt="" class="img-fluid">
                        </a>

                        <div class="post-content">
                            <span class="date text-uppercase text-sm">17 june 2019</span>
                            <a href="blog-single.php">
                                <h4>If you are starting off with a new domain name with no traffic so to speak of you.</h4>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="post mb-5">
                        <a class="image-content" href="article.php">
                            <img src="images/blog/minimal-2.jpg" alt="" class="img-fluid">
                        </a>
                        ...
                        <div class="post-content">
                            ...
                            <a href="blog-single.php">
                                <h4>WordPress has a great number of points that can be made in favor of its use.</h4>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="post mb-5">
                        <a class="image-content" href="article.php">
                            <img src="images/blog/minimal-3.jpg" alt="" class="img-fluid">
                        </a>
                        ...
                        <div class="post-content">
                            ...
                            <a href="article.php">
                                <h4>Elegant Brand Identity for Artistic Glass Installations more Than A White Coat</h4>
                            </a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="post mb-5 mb-lg-0">
                        <a class="image-content" href="article.php">
                            <img src="images/blog/minimal-4.jpg" alt="" class="img-fluid">
                        </a>
