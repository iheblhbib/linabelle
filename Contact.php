<?php
    ...
    if(!empty($_POST['send'])){
        ...
        $query = mysqli_query($con,"INSERT INTO contact (name,email,subject,message) 
...
$toEmail = "iheblhbibb@gmail.com";
$message = "Form:  " . $name." :\n".$message;
//$mailHeaders = "Form: " . $name . "<".$email.">\r\n";
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                while($liste = mysqli_fetch_array($query7)){
                                    ...
                                    <td>'.$price.'</td>                                
                                    <td>'.$quantity.'</td>
                                    <td><a href="contact.php?del='.$idprod.'" class="del"><img src="images/trash.png" ></a></td>
                                    </tr>';
                                } }?>
    ...
    <section class="page-title section pb-0">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <h2 class="text-capitalize mb-0 text-lg">Vouloir en savoir davantage?<br> contactez-nous en ligne, via notre ligne téléphonique ou écrivez-nous</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center" align="center">
                <div class="col-lg-4 col-md-4 " >
                    <h4>Contact Info</h4>
                    <p>Produit par l'entreprise MOUICI H <br>De fabrication de PRODUITS COSMETIQUES ET D'HYGIÈNE CORPORELLE.</p>
                </div>
                <div class="col-lg-4 col-md-4">
                    <h4>Adresse</h4>
                    <p>100 LGTS ,Djebel Annoual <br>TEBESSA 12000</p>
                </div>
                <div class="col-lg-4 col-md-4">
                    <h4>Contact</h4>
                    <p class="mb-0">linabelle.cosmetics@gmail.com</p>
                    <p class="mb-0">037 56 33 90</p>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <form id="contact-form" class="contact__form mt-5" method="POST" action="Contact.php">
                        <!-- form message -->
                        <div class="row">
                            <div class="col-12">
                                <?php if(!empty($msg2) == "true"){ 
                                    echo '<div class="alert alert-success contact__msg" role="alert">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    <input name="subject" type="text" class="form-control" placeholder="Votre Sujet" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="text-center">
                                    <input type="submit" name="send" class="btn btn-main" value="Envoyer Message">
                                </div>
                            </div>
                        </div>
